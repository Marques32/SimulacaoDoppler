...
function calculaComprimentoPercebidoAproximando(){
    ...
    if(veiculo.velocidade != 0 && observador.velocidade != 0){
        ...
        comprimentoPercebido = (velocidadeSom+parseInt(velocidadeObservador.value))/frentesOndasMov.frequencia;
    }
...
function calculaComprimentoPercebidoAfastando(){
    ...
    if(veiculo.velocidade != 0 && observador.velocidade != 0){
        ...
        comprimentoPercebido = (velocidadeSom+velObservador)/frentesOndasMov.frequencia;
    }
